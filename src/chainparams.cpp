...
// Copyright (c) 2015-2019 The XYZK developers
...
public:
    CMainParams()
    {
        ...
        // validation by-pass
        consensus.nConcreteBadBlockTime = 1471401614;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nConcreteBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
...
public:
    CTestNetParams()
    {
        ...
        // validation by-pass
        consensus.nConcreteBadBlockTime = 1489001494; // Skip nBit validation of Block 201 per PR #915
        consensus.nConcreteBadBlockBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
